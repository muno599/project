...
var style_boundary_polygon_1 = function(feature, resolution){
    ...
    var value = feature.get("q2wHide_OSM_ID");
    var labelText = "";
    size = 0;
    ...
    if (value >= -1793195.000000 && value <= -398421.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -398421.600000 && value <= -398413.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -398413.200000 && value <= -398404.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -398404.400000 && value <= -398394.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -398394.400000 && value <= -398386.000000) {
            style = [ new ol.style.Style({
